          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-2">Add a new subject to organize curriculum content</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700 p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-400">
                    Link this subject to an exam (e.g., JEE, NEET, CBSE)
                  </p>
                </div>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700 p-6 sticky top-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm text-center">
                  Subjects organize curriculum content into manageable units
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Organize curriculum content</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                    <span>Group related chapters together</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                    <span>Enable exam-based filtering</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-blue-300">Manage Exams</span>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-purple-300">Add Chapter</span>
              ...
              <div className="pt-6 border-t border-gray-700">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li>• Assign subjects to relevant exams</li>
                  <li>• Plan your subject order carefully</li>
                </ul>
              </div>
            </div>
          </div>
