      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="relative bg-white/80 backdrop-blur-xl border border-white/60 rounded-2xl p-6 shadow-xl shadow-emerald-500/20 transform rotate-y-3 rotate-x-3 z-20 w-full max-w-sm mx-auto"
          >
             {/* Fake UI Content */}
             <div className="flex justify-between items-center mb-4">
                <div className="space-y-1">
                  <div className="h-1.5 w-16 bg-slate-800/10 rounded"></div>
                  <div className="h-3 w-28 bg-slate-800/20 rounded font-semibold text-slate-700 text-sm">biologykingdom Pro</div>
                </div>
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-emerald-500 to-sky-600 shadow-lg"></div>
             </div>
             
             <div className="space-y-3">
               {/* Progress Chart Mock */}
               <div className="h-24 rounded-lg bg-gradient-to-r from-emerald-50 to-sky-50 border border-white/40 flex items-end justify-between p-3 px-4">
                  {[40, 70, 50, 90, 60, 80].map((h, i) => (
                    <motion.div 
                      ...
                      className="w-2 bg-gradient-to-t from-emerald-500 to-sky-500 rounded-t opacity-80 shadow-lg"
                    />
                  ))}
               </div>
